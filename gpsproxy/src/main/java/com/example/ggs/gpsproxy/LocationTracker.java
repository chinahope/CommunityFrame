...
//                }
    ...
    public final void onLocationChanged(@NonNull Location location) {
        ...
        onLocationFound(location.getLongitude(),location.getLatitude(),location.getAltitude(),location.getLongitude()+","+location.getLatitude());
    }
     ...
     *
     */
    protected abstract void onLocationFound(@NonNull double longitude, @NonNull double latitude, @NonNull double altitude, @NonNull String s);
    ...
    public Location getLastLocation(){
        if(mLocationManagerService != null){
            return mLocationManagerService.getLastKnownLocation(LocationManager.GPS_PROVIDER);
        }
        return null;
    }
}